...
import { Loader2, Upload, Calendar, MapPin, ArrowRight, FileText, CreditCard, RefreshCw } from "lucide-react"
            ...
            <DialogContent className="max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-4">
                    ...
                    <div className="md:col-span-1 space-y-6">
                        ...
                        <div className={`p-4 rounded-xl border w-full text-center shadow-sm ${planDetails?.level >= 3 ? 'bg-gradient-to-br from-purple-50 to-indigo-100 border-purple-200' :
                            ...
                            {planDetails ? (
                                <>
                                    ...
                                    <p className={`text-xl font-bold mb-3 ${planDetails?.level >= 3 ? 'text-purple-800' :
                                    ...
                                    <div className="flex flex-col gap-2 w-full">
                                        <Button
                                            ...
                                            size="sm"
                                            asChild
                                            className={`w-full h-auto py-2 whitespace-normal ${planDetails?.level >= 3 ? 'border-purple-300 text-purple-800 hover:bg-purple-100' :
                                                planDetails?.level === 2 ? 'border-yellow-300 text-yellow-800 hover:bg-yellow-100' :
                                                    'border-blue-300 text-blue-800 hover:bg-blue-100'
                                                }`}
                                        >
                                            <Link href="/certificate" target="_blank" className="flex items-center justify-center">
                                                <FileText className="mr-2 h-4 w-4 shrink-0" />
                                                <span>सर्टिफिकेट डाउनलोड करें (Certificate)</span>
                                            </Link>
                                        </Button>
                                        <Button
                                            variant="outline"
                                        ...
                                        >
                                            <Link href="/id-card" target="_blank" className="flex items-center justify-center">
                                        ...
                                        >
                                            <div className="flex items-center justify-center">
                                                ...
                                                <span>सदस्यता अपडेट करें (Update Membership)</span>
                                            </div>
                                        </Button>
                                    </div>
                                </>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Button
                                        className="w-full h-auto py-2 whitespace-normal bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white border-0 shadow-md"
                                        onClick={onOpenMembership}
                                    >
                                        <span>सदस्यता लें (Become a Member)</span>
                                    </Button>
                                </div>
                            )}
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="md:col-span-1 space-y-4">
                        ...
                        <div className="pt-4">
                            <Button type="submit" disabled={saving} className="w-full h-auto py-2 whitespace-normal">
                                {saving && <Loader2 className="mr-2 h-4 w-4 animate-spin shrink-0" />}
                                <span>परिवर्तन संचित करें (Save Changes)</span>
                            </Button>
                        </div>
                    </form>
                        ...
                        <div className="space-y-4">
                            {loadingEvents ? (
                                ...
                                <div className="text-center py-8 space-y-3 bg-muted/20 rounded-lg p-4">
                                    ...
                                    <Button variant="outline" size="sm" asChild className="w-full h-auto py-2 whitespace-normal">
                                        <Link href="/events" onClick={() => onOpenChange(false)} className="flex items-center justify-center">
                                            <span>आगामी कार्यक्रमों के लिए पंजीकरण करें</span>
