        ...
        <div className="max-w-5xl mx-auto space-y-32">
          ...
          <div className="text-center space-y-12 min-h-[75vh] flex flex-col justify-center items-center">
            ...
            <div className="relative group mb-4">
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-400 to-amber-400 rounded-full blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200" />
          ...
          <div className="space-y-20 pt-10">
            ...
            <div className="text-center">
              <h2 className="text-4xl md:text-6xl font-extrabold bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent py-4 inline-block">
                एक परिचय
              </h2>
            </div>
            ...
            <div className="relative group max-w-4xl mx-auto">
              <div className="absolute -inset-4 bg-gradient-to-r from-orange-100 to-amber-100 rounded-[3rem] blur-xl opacity-50 group-hover:opacity-80 transition duration-500" />
            ...
            <div className="flex flex-col items-center pt-10">
              <div className="w-px h-16 bg-gradient-to-b from-transparent via-orange-300 to-transparent mb-6" />
            ...
            <div className="grid md:grid-cols-3 gap-8 relative px-4 pb-20">
              {/* Objective 1 */}
              <div className="group relative p-8 rounded-[2rem] bg-stone-50/50 backdrop-blur-xl border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgba(251,146,60,0.12)] hover:-translate-y-2 transition-all duration-500">
              ...
              {/* Objective 2 */}
              <div className="group relative p-8 rounded-[2rem] bg-stone-50/50 backdrop-blur-xl border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgba(245,158,11,0.12)] hover:-translate-y-2 transition-all duration-500 md:translate-y-6">
