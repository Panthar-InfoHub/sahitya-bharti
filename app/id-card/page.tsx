  ...
  if (!profile || profile.plan !== 'premium') {
      return (
          <div className="min-h-screen flex flex-col items-center justify-center p-4 text-center">
              ...
              <p className="text-gray-600 mb-4">यह आईडी कार्ड केवल प्रीमियम सदस्यों के लिए उपलब्ध है। (This ID Card is available for Premium members only.)</p>
              <Link href="/">
    ...
    <div className="min-h-screen bg-slate-100 p-8 flex flex-col items-center print:bg-white print:p-0">
      ...
      >
        ...
        <div className="relative z-10 mt-2 text-center text-white">
            ...
            <p className="text-xs text-yellow-200">हिन्दी साहित्य भारती</p>
        </div>
